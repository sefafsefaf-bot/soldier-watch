...
export interface Soldier {
  ...
  recordingUrl: string;
  /**
   * If set, the UI will fetch live HR / temperature / blood pressure from this URL
   * instead of using the static values above. The endpoint should return JSON like:
   *   { heartRate: 82, bodyTemp: 36.8, bp: { systolic: 120, diastolic: 80 } }
   */
  liveDataUrl?: string;
}

// NOTE: Replace this placeholder with the ESP32's local IP (e.g. http://192.168.1.42/data)
// when you have it. Only this constant needs to change.
...
export const soldiers: Soldier[] = [
  {
    ...
    battery: 87,
    location: { lat: 24.7136, lng: 46.6753, label: "Sector 7-A" },
    status: "ok",
  ...
  },
  {
    ...
    battery: 64,
    location: { lat: 24.7150, lng: 46.6770, label: "Sector 7-B" },
    status: "warn",
  ...
  },
  {
    ...
    battery: 41,
    location: { lat: 24.7170, lng: 46.6720, label: "Sector 8-C" },
    status: "danger",
  ...
  },
  {
    ...
    battery: 92,
    location: { lat: 24.7110, lng: 46.6800, label: "Sector 6-D" },
    status: "ok",
  ...
  },
  {
    ...
    battery: 73,
    location: { lat: 24.7130, lng: 46.6740, label: "Sector 7-A" },
    status: "ok",
